...
def _write_development_project(project_root: Path, scene_path: Path, destination: Path, safe_name: str) -> None:
    ...
    runtime_sources = {
        ...
        project_root / "editor" / "runtime" / "viewport_render_order.py": runtime_dir / "viewport_render_order.py",
        project_root / "editor" / "runtime" / "viewport_systems.py": runtime_dir / "viewport_systems.py",
        project_root / "editor" / "runtime" / "benchmark_gameplay_compat.py": runtime_dir / "benchmark_gameplay_compat.py",
        ...
        project_root / "editor" / "runtime" / "viewport_logic_api.py": runtime_dir / "viewport_logic_api.py",
        project_root / "editor" / "runtime" / "viewport_logic_api_behavior.py": runtime_dir / "viewport_logic_api_behavior.py",
        project_root / "editor" / "runtime" / "viewport_logic_api_dialogue.py": runtime_dir / "viewport_logic_api_dialogue.py",
        project_root / "editor" / "runtime" / "viewport_logic_api_media.py": runtime_dir / "viewport_logic_api_media.py",
        project_root / "editor" / "runtime" / "viewport_command_queue.py": runtime_dir / "viewport_command_queue.py",
        project_root / "editor" / "runtime" / "viewport_editor_view_commands.py": runtime_dir / "viewport_editor_view_commands.py",
        ...
        project_root / "editor" / "runtime" / "viewport_logic_event_updater.py": runtime_dir / "viewport_logic_event_updater.py",
        ...
        project_root / "engine" / "logic" / "contracts.py": runtime_dir / "contracts.py",
        project_root / "engine" / "logic" / "physics_event_dispatch.py": runtime_dir / "physics_event_dispatch.py",
        project_root / "engine" / "logic" / "animation_event_dispatch.py": runtime_dir / "animation_event_dispatch.py",
...
def _validate_exported_project(destination: Path, report: BuildReport) -> None:
    required = (
        ...
        "zennity_runtime/viewport_render_order.py",
        "zennity_runtime/viewport_systems.py",
        "zennity_runtime/benchmark_gameplay_compat.py",
        ...
        "zennity_runtime/viewport_logic_api.py",
        "zennity_runtime/viewport_logic_api_behavior.py",
        "zennity_runtime/viewport_logic_api_dialogue.py",
        "zennity_runtime/viewport_logic_api_media.py",
        "zennity_runtime/viewport_command_queue.py",
        "zennity_runtime/viewport_editor_view_commands.py",
        ...
        "zennity_runtime/viewport_logic_event_updater.py",
        ...
        "zennity_runtime/contracts.py",
        "zennity_runtime/physics_event_dispatch.py",
        "zennity_runtime/animation_event_dispatch.py",
