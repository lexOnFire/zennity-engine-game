...
def build_logic_graph_ui(self) -> None:
    ...
    self.category_combo.addItem(tr("graph.categories.ui", "Interface (UI)"), "UI")
    ...
    # Search e Scope Filter para Variáveis
    self.blackboard_search_edit = QLineEdit()
    self.blackboard_search_edit.setObjectName("BlackboardSearch")
    self.blackboard_search_edit.setPlaceholderText("Buscar variável...")
    self.blackboard_search_edit.setClearButtonEnabled(True)
    data_layout.addWidget(self.blackboard_search_edit)

    self.blackboard_filter_scope_combo = QComboBox()
    self.blackboard_filter_scope_combo.addItem("Todas", "all")
    self.blackboard_filter_scope_combo.addItem("Objeto", "object")
    self.blackboard_filter_scope_combo.addItem("Cena", "scene")
    self.blackboard_filter_scope_combo.addItem("Projeto", "project")
    data_layout.addWidget(self.blackboard_filter_scope_combo)

    self.blackboard_tree = QTreeWidget()
    self.blackboard_tree.setHeaderLabels(["Nome", "Tipo", "Escopo", "Padrão"])
    self.blackboard_tree.setDragEnabled(True)
    self.blackboard_tree.setToolTip("Arraste para o canvas para criar Ler (Get) ou dê duplo clique")
    ...
    self.blackboard_get_button = QPushButton("Ler (Get)")
    self.blackboard_set_button = QPushButton("Definir (Set)")
    ...
    data_hint = QLabel("Blackboard — estado e memória compartilhada usados pelos Logic Graphs.")
    data_hint.setObjectName("PanelHint")
    data_hint.setWordWrap(True)
    data_layout.addWidget(data_hint)
    self.library_tabs.addTab(data_page, "Variáveis")
