...
class EditorBootstrapController:
    ...
    def configure(self) -> None:
        ...
        h._connect_existing_toolbar_actions()
        h._configure_main_menus()
        h._configure_tool_actions()
        h._configure_create_menu()
        h._connect_create_panel()
        h._configure_edit_menu()
        h._refresh_assets()
        h._refresh_prefabs()
        h.prefab_tree.itemDoubleClicked.connect(h._instantiate_prefab_item)
        h.prefab_tree.setContextMenuPolicy(Qt.CustomContextMenu)
        h.prefab_tree.customContextMenuRequested.connect(h._open_prefab_menu)
