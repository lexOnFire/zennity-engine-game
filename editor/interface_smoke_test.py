...
class InterfaceSmokeTest(QMainWindow):
    ...
    def _build_docks(self) -> None:
        ...
        self.btn_delete_renderer.setStyleSheet("color: #ff5555; background: transparent; border: none; font-weight: bold;")
        ...
        self.btn_delete_audio.setStyleSheet("color: #ff5555; background: transparent; border: none; font-weight: bold;")
        ...
        audio_file_row = QWidget()
        audio_file_layout = QHBoxLayout(audio_file_row)
        audio_file_layout.setContentsMargins(0, 0, 0, 0)
        self.audio_path_field = QLineEdit()
        self.audio_path_field.setReadOnly(True)
        self.audio_path_button = QPushButton("...")
        self.audio_path_button.setFixedWidth(28)
        audio_file_layout.addWidget(self.audio_path_field)
        audio_file_layout.addWidget(self.audio_path_button)
        audio_form.addRow("Áudio", audio_file_row)
